...
- **10-point hook smoke test suite**: Installer-integrated verification that
  every hook fires correctly with synthetic input (extended in H.4.3 with
  3 confirmation-variant cases)
