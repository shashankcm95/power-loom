...
- **GitHub repo** kept at `claude-skills-consolidated` for backward-compat with phase tags + bookmarks; rename deferred to a future maintenance phase.
...
[1.0.0]: https://github.com/shashankcm95/claude-skills-consolidated/releases/tag/v1.0.0
[0.8.0]: https://github.com/shashankcm95/claude-skills-consolidated/releases/tag/phase-H.4.3
[0.7.0]: https://github.com/shashankcm95/claude-skills-consolidated/releases/tag/phase-H.7.4
[0.6.0]: https://github.com/shashankcm95/claude-skills-consolidated/releases/tag/phase-CS-6
[0.5.0]: https://github.com/shashankcm95/claude-skills-consolidated/releases/tag/phase-H.5.0
